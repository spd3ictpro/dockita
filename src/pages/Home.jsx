...
const categories = [
  { path: '/screening', icon: '📋', title: 'Screening', desc: 'Malaysia CPG guidelines, mammogram & iFOBT due checkers', color: '#4f6ef7' },
    ...
    <div className="page home-page">
      ...
      <div className="home-quick-tools">
        ...
        <div className="quick-tool-list">
          ...
          <button className="quick-tool" onClick={() => navigate('/screening')}>📅 Mammogram Due</button>
